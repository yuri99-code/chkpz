<?php  return array (
  ...
  'dashboard_customizable_desc' => 'Allow users to customize this dashboard for their accounts: create, delete and change position or size of widgets.',
  'dashboard_description_desc' => 'A short description of the Dashboard.',
  'dashboard_edit' => 'Edit the settings and Widget placements for this Dashboard',
  'dashboard_hide_trees' => 'Hide Left-Hand Trees',
  'dashboard_hide_trees_desc' => 'Checking this will hide the left-hand trees when this Dashboard is rendered on the welcome page.',
  'dashboard_name_desc' => 'The name of the Dashboard.',
  ...
  'dashboard_reserved_general_desc' => 'Note that this is a protected, built-in Dashboard. Its general values are locked, but other specifications (such as assigned Widgets) are editable by users with the appropriate permissions.',
  ...
  'dashboard_err_name_reserved' => 'The dashboard name “[[+reservedName]]” is reserved. Please choose another name.',
